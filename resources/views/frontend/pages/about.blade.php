...
@section('content')
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="{{route('anasayfa')}}">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">About</strong></div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                ...
                {{--! {{$about->image ?? 'images/blog_1.jpg' var ise soldaki yok ise sağdakini kullan anlam ıverir  --}}
          ...
          <div class="col-md-5">
            ...
            <p>{!! $about->content !!}</p>
            {{--! Sebebi ckeditorde değişim yaptıgında html olarak görmesini sağlar php  --}}
